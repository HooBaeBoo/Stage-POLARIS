...
- Goal for today :
  - [-] Fix bug :
    ...
    - [ ] Values for Join are incorrect! Because of the format but even after!
  - [ ] Comment more and change variables names to more intuitive ones
  - [ ] Save all paths computed
