...
:END:
****** TODO [[http://execo.gforge.inria.fr/doc/latest-stable/][Execo]]
...
****** STARTED [[http://simgrid.gforge.inria.fr/tutorials.php][First grasp]]
:LOGBOOK:
...
- SimDag : Directed Acyclic Graph (DAG), we assume vertices represent tasks ans edges represents constraints and/or data movements between tasks.
